        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className="flex-1 md:ml-60 flex flex-col min-h-screen">
                ...
                <main className="flex-1 p-4 sm:p-6 lg:p-8 bg-gray-50">
                    {usePage().props.auth.is_impersonating && (
                        <div className="mb-6 bg-indigo-600 text-white p-4 rounded-xl flex items-center justify-between shadow-lg ring-1 ring-indigo-500 ring-offset-2 ring-offset-gray-50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-sm">Superadmin Impersonation Mode</h3>
                                    <p className="text-indigo-200 text-xs mt-0.5">You are currently logged in as {user.name}.</p>
                                </div>
                            </div>
                            <Link href={route('impersonate.leave')} method="post" as="button" className="px-4 py-2 bg-white text-indigo-600 font-bold text-sm rounded-lg hover:bg-indigo-50 transition-colors shadow-sm">
